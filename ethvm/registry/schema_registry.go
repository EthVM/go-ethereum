...
// SchemaRegistryClient defines the api for all clients interfacing with schema registry
...
// KafkaSchemaRegistryClient is a basic http client to interact with schema registry
...
func NewSchemaRegistryClient(connect []string) *KafkaSchemaRegistryClient {
	client := &http.Client{
		Timeout: timeout,
	}
...
func (client *KafkaSchemaRegistryClient) GetSchema(id int) (*goavro.Codec, error) {
...
func (client *KafkaSchemaRegistryClient) GetSubjects() ([]string, error) {
...
func (client *KafkaSchemaRegistryClient) GetVersions(subject string) ([]int, error) {
...
func (client *KafkaSchemaRegistryClient) getSchemaByVersionInternal(subject string, version string) (*goavro.Codec, error) {
...
func (client *KafkaSchemaRegistryClient) GetSchemaByVersion(subject string, version int) (*goavro.Codec, error) {
...
func (client *KafkaSchemaRegistryClient) GetLatestSchema(subject string) (*goavro.Codec, error) {
	return client.getSchemaByVersionInternal(subject, latestVersion)
}

// CreateSubject adds a schema to the subject
func (client *KafkaSchemaRegistryClient) CreateSubject(subject string, codec *goavro.Codec) (int, error) {
...
func (client *KafkaSchemaRegistryClient) IsSchemaRegistered(subject string, codec *goavro.Codec) (int, error) {
	schema := schemaResponse{codec.Schema()}
	json, err := json.Marshal(schema)
	if err != nil {
		return 0, err
...
func (client *KafkaSchemaRegistryClient) DeleteSubject(subject string) error {
...
func (client *KafkaSchemaRegistryClient) DeleteVersion(subject string, version int) error {
...
func (client *KafkaSchemaRegistryClient) httpCall(method, uri string, payload io.Reader) ([]byte, error) {
